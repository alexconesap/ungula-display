...
namespace ungula::display {
    ...
    void gfx_fillRoundRect(int32_t pos_x, int32_t pos_y, int32_t width, int32_t height,
                           int32_t radius, uint16_t color) {
        gfx.fillRoundRect(pos_x, pos_y, width, height, radius, color);
    }

    void gfx_drawRoundRect(int32_t pos_x, int32_t pos_y, int32_t width, int32_t height,
                           int32_t radius, uint16_t color) {
