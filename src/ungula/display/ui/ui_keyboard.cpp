...
static void draw_text_display()
{
        ...
        int disp_w = s_password_mode ? (KEYBOARD_WIDTH - padding * 2 - 72) :
                                       (KEYBOARD_WIDTH - padding * 2);
        int disp_h = 38;
...
void keyboard_draw()
{
        ...
        gfx.drawRoundRect(s_x, s_y, KEYBOARD_WIDTH, KEYBOARD_HEIGHT, UI_RADIUS_NORMAL,
                          UI_COLOR_ACCENT);
        gfx.drawRoundRect(s_x + 1, s_y + 1, KEYBOARD_WIDTH - 2, KEYBOARD_HEIGHT - 2,
