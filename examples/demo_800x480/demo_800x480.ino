...
void drawScreen() {
    ...
    ui_draw_text_centered(0, TITLE_Y, UI_SCREEN_WIDTH, "UNGULA UI LIBRARY TEST", UI_COLOR_TEXT_PRIMARY, UI_TEXT_SIZE_LARGE);
...
void loop() {
    ...
    if (ui_touch_in_rect(tx, ty, START_X, BTN_Y, BTN_W, BTN_H)) {
        ui_draw_button(START_X, BTN_Y, BTN_W, BTN_H, "+", UI_COLOR_BTN_PRESSED, UI_COLOR_TEXT_PRIMARY, UI_TEXT_SIZE_LARGE);
        border_size += 5;
        delay(200);
    }
    ...
    if (ui_touch_in_rect(tx, ty, STOP_X, BTN_Y, BTN_W, BTN_H)) {
        ui_draw_button(STOP_X, BTN_Y, BTN_W, BTN_H, "-", UI_COLOR_BTN_PRESSED, UI_COLOR_TEXT_PRIMARY, UI_TEXT_SIZE_LARGE);
        border_size -= 5;
        delay(200);
    }
